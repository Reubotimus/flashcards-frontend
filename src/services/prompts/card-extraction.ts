export const cardExtractionPromptText = `**Goal:** Convert the provided document into a list of valuable flashcards which will be put into the fsrs spaced repetition algorithm. Generate as many high quality flashcards using the bellow document as a guide for finding the highest yield flashcards in the document.
